            ...
            <form wire:submit.prevent="storeProject">
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        <label for="associated_institution" class="form-label required">{{ __('Associated Institution') }}</label>
                        <select class="form-select" id="associated_institution" wire:model.lazy="associated_institution">
                            <option selected value="">Select</option>
                        </select>
