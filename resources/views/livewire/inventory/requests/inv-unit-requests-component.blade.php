    ...
    <div class="row" x-data="{ filter_data: @entangle('filter'),create_new: @entangle('createNew') }">
        <div class="col-12">
            <div class="card">                
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Request (<span class="text-danger fw-bold">{{ $requests->total() }}</span>)
                ...
                <div class="card-body">
                    @include('livewire.inventory.requests.inc.new-request-form')
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        @include('livewire.inventory.requests.inc.request-table-list')
                        <div class="row mt-4">
                            <div class="col-md-12">
