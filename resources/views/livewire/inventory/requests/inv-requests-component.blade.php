<div>
                                ...
                                <tbody>
                                    @foreach ($requests as $key => $request)
                                        <tr>
                                            ...
                                            <td>{{ $request->requestable->name??'N/A' }}</td>
                                            <td>{{ $request->customer->name??$request->department->name??'N/A' }}</td>
                                            ...
                                            <td class="table-action">     
                                                @if ($request->status=='Pending')
                                                    ...
                                                    <a href="{{URL::signedRoute('finance-request_items', $request->request_no)}}" class="action-ico btn-sm btn btn-outline-success mx-1"><i class="fa fa-edit"></i></a>
                                                @else
                                                
                                                    <a href="{{URL::signedRoute('finance-request_view', $request->request_no)}}" class="action-ico btn-sm btn btn-outline-success mx-1"><i class="fa fa-eye"></i></a>
    ...
    @include('livewire.inventory.requests.inc.new-item-request-modal')
