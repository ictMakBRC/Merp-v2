<div wire:ignore.self class="modal fade" id="deleteConfirm" data-bs-backdrop="static"
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <h6>{{ __('logistics.sure_to_remove') }}<br>{{ __('logistics.irreversible_action') }}</h6>
    ...
    <div class="modal-footer">
      ...
      data-dismiss="modal">{{ __('logistics.Yes') }}</button>
