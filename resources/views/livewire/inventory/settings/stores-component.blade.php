<div>
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        store (<span class="text-danger fw-bold">{{ $stores->total() }}</span>)
                                    ...
                                    @foreach ($stores as $key => $store)
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <button wire:click="editData({{ $store->id }})" data-bs-toggle="modal" data-bs-target="#updateCreateModal" class="action-ico btn-sm btn btn-outline-success mx-1">
    ...
    @include('livewire.inventory.settings.inc.new-store-form')
    @push('scripts')
            <script>
