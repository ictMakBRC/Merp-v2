<div wire:ignore.self class="modal fade" id="updateCreateModal" tabindex="-1" role="dialog" aria-labelledby="updateCreateModalTitle" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form  @if ($toggleForm) wire:submit.prevent="updateInvStorageSection" @else wire:submit.prevent="sectionInvStorageSection" @endif >             
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-8">
                            ...
                            <select class="form-select select2" id="store_id" wire:model.defer="store_id">
