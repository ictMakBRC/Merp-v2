<div class="ms-auto">
    <a type="button" class="btn btn-sm btn-outline-success me-2" wire:click="refresh()" data-bs-toggle="tooltip"
    ...
    btn-outline-danger @endif"
        @click='create_new = ! create_new' data-bs-toggle="tooltip" data-bs-placement="right"
