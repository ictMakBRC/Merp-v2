            ...
            <div class="main-icon-menu-body">
                <div class="position-reletive h-100" data-simplebar style="overflow-x: hidden;">
                    <ul class="nav nav-tabs" role="tablist" id="tab-menu">
                        ...
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Finance" data-bs-trigger="hover">
                            <a href="#financeManagement" id="financeManagement-tab" class="nav-link">
                                <i class="ti ti-report-money menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->

                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Inventory Management" data-bs-trigger="hover">
                            <a href="#inventoryManagement" id="inventoryManagement-tab" class="nav-link">
                                <i class="ti ti-tallymarks menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->

                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Assets Management" data-bs-trigger="hover">
                            <a href="#assetsManagement" id="assetsManagement-tab" class="nav-link">
                                <i class="ti ti-transfer-in menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->

                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Procurement Management" data-bs-trigger="hover">
                            <a href="#procurementManagement" id="procurementManagement-tab" class="nav-link">
                                <i class="ti ti-truck-delivery menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->

                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Documents Management" data-bs-trigger="hover">
        ...
        <div class="main-menu-inner">
            ...
            <div class="topbar-left">
                <a href="{{ route('home') }}" class="logo">
                    <span>
                        <img src="{{ asset('assets/images/logos/merp-logo.png') }}" alt="logo-large" class="logo-lg logo-dark">
                        <img src="{{ asset('assets/images/logos/merp-logo.png') }}" alt="logo-large" class="logo-lg logo-light">
                    </span>
                </a><!--end logo-->
            </div><!--end topbar-left-->
            <!--end logo-->
