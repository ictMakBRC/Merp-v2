            ...
            <div class="card shadow-sm border-0 overflow-hidden">
                <div class="card-body">
                    <div class="profile-avatar text-center">
                        <img src="{{ $profile?->logo ? asset('storage/' . $profile?->logo) : asset('assets/images/users/user-vector.png') }}"
                        ...
                        <div class="card-body">
                            ...
                            wire:submit.prevent="updateProfileInformation" @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="logo" class="form-label">Official Logo<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="logo2" class="form-label">Alternative Logo</label>
