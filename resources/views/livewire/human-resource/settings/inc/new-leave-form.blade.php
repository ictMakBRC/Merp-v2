        ...
        <div class="modal-content">
            ...
            <form @if ($toggleForm) wire:submit.prevent="updateLeave" @else wire:submit.prevent="storeLeave" @endif>
                    ...
                    <div class="row">
                        <div class="row col-md-12">
                            ...
                            <div class="mb-3 col-md-2">
                                ...
                                <input type="number" id="duration" class="form-control" wire:model.defer="duration"
                                    required>
                                @error('duration')
                                <div class="text-danger text-small">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="number" id="notice_days" class="form-control"
                                    wire:model.defer="notice_days" required>
                                @error('notice_days')
                                <div class="text-danger text-small">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal" wire:click="close()">{{
