<div>
    @include('livewire.human-resource.performance.warnings.breadcrumps', [
    'heading' => '',
    ])
    <div class="container-fluid">
                            ...
                            <div class="col-lg-5 align-self-center">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <h4 class="mt-0">{{$warning->subject}}</h4>
        ...
        <div class="row">
            <div class="col-lg-6">
                @include('livewire.human-resource.performance.warnings.attachments')
            </div>
            <!--end col-->
            @if($warning->acknowledged_at == null)
            <div class="col-lg-6">
            ...
            @include('livewire.human-resource.performance.warnings.comments')
    ...
    @include('livewire.human-resource.performance.warnings.acknowledgement-modal')
    <!--end modal-->
</div>