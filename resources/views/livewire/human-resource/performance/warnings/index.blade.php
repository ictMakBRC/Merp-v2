                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    ...
                                    Warnings (<span class="text-danger fw-bold">{{ $warnings->total() }}</span>)
                                ...
                                <div class="ms-auto">
                                    ...
                                    <a href="{{route('warnings.create')}}" class="btn btn-sm me-2 btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-action d-flex">
                                            ...
                                            <div wire:click="deleteData({{ $warning->id }})" data-bs-toggle="modal"
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No warnings recorded yet ...</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="btn-group float-end">
                                    {{ $warnings->links('vendor.livewire.bootstrap') }}
                                </div>
                            </div>
                        </div>
                    </div> <!-- end tab-content-->
