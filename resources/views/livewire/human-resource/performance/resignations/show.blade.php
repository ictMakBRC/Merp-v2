<div>
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-5 align-self-center">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <h4 class="mt-0">{{$resignation->reason}}</h4>
                            ...
                            <div class="col-lg-5 ms-auto">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-8">
                                        @if($resignation->acknowledged_at != null)
                                        <span>Yes</span>
                                        @else
                                        <span>No</span>
                                        @endif
        ...
        <div class="row">
            <div class="col-lg-6">
                @include('livewire.human-resource.performance.resignations.attachments')
            </div>
            <!--end col-->
            @if($resignation->acknowledged_at == null)
            <div class="col-lg-6">
                                ...
                                <div class="row bg-light p-3">
                                    <div class="col-11 toast mb-2 fade show" role="alert" aria-live="assertive"
                                        ...
                                        <div class="toast-body">
                                            Please acknowledge receipt of this resignations.
