    ...
    <form wire:submit.prevent>
        <div class="row">
            ...
            <div class="mb-3 col-md-4">
                ...
                <div class="text-primary text-small" wire:loading wire:target="signature">Uploading signature
                </div>
                @error('signature')
                <div class="text-danger text-small">{{ $message }}</div>
                @enderror
        ...
        <div class="modal-footer">
            ...
            <div class="input-group mb-3">
                ...
                <button class="btn btn-outline-primary" type="button" onclick="copyText()" wire:click='resetToken()'
            ...
            <div class="form-check  py-1 ms-2">
                <input class="form-check-input" type="checkbox" id="generateToken" checked wire:model="generateToken">
                <label class="form-check-label text-primary fw-bold" for="generateToken">{{ __('Generate API Token')
                    }}</label>
            </div>
            @endif
