<div>
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Asset Classifications (<span class="text-danger fw-bold">{{ $classifications->total() }}</span>)
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input id="search" type="text" class="form-control"
                                    wire:model.lazy="search" placeholder="search">
                            </div>
                            <hr>
                        </div>
                                    ...
                                    @foreach ($classifications as $key => $classification)
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <button wire:click="editData({{ $classification->id }})" data-bs-toggle="modal" data-bs-target="#updateCreateModal" class="action-ico btn-sm btn btn-outline-success mx-1">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="btn-group float-end">
                                    {{ $classifications->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div> <!-- end tab-content-->
    ...
    @include('livewire.assets-management.settings.inc.new-classification-form')
    @push('scripts')
            <script>
