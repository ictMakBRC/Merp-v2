<div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Click On the currency to view submissions.</p>
                </div><!--end card-header-->
                <div class="card-body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills nav-justified" role="tablist">
                        @foreach ($payroll_rates as $payroll_rate)
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link  @if ($active_currency == $payroll_rate->currency_id) active @endif"
                                    data-bs-toggle="tab" href="javsacript:void(0)"
                                    wire:click="$set('active_currency',{{ $payroll_rate->currency_id }})" role="tab"
                                    aria-selected="true">{{ $payroll_rate->currency->code }}</a>
                            </li>
                        @endforeach
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane p-3 active" id="home-1" role="tabpanel">
                            ...
                            <div class="card m-1">
                                @foreach ($payroll_rates->where('currency_id', $active_currency) as $payroll_rate)
                                                        ...
                                                        <div class="col-auto"> 
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="#">CBS</a>
                                                                </div>
                                                            </div>         
                                                        </div><!--end col-->
                                                    </div>  <!--end row-->                                  
                                            ...
                                            <div class="col-md-3">
                                                <div class="scrollable list-group">
                                                    <a href="javascript:void(0)" style="font-size: 10px"
                                                        wire:click="setUnit('0', '0')"
                                                        class="list-group-item active d-flex align-items-center mb-1">
                                                        <span>All Units</span>
                                                        <span
                                                            class="badge bg-info  ms-auto">{{ $unit_groups->count() }}</span></a>
                                                    @foreach ($unit_groups->where('currency_id', $payroll_rate->currency_id) as $unit)
                                                        <a href="javascript:void(0)" style="font-size: 10px"
                                                            wire:click='setUnit({{ $unit->requestable_id }}, {{ json_encode($unit->requestable_type) }})'
                                                            class="list-group-item active d-flex align-items-center mb-1">
                                                            <span>{{ $unit->requestable->name . ' ' . $unit->total_amount }}</span>
                                                            <span
                                                                class="badge bg-info  ms-auto">{{ $unit->submission_count }}</span></a>
                                                    @endforeach
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                <div class="card-body">
                                                    ...
                                                    @endphp
                                                    <h6 class="text-success text-center">Submitted Employee Salary list
                                                        Earning in {{ $payroll_rate->currency?->code }}</h6>
                                                    <table id="payrollTable" class="b-top-row"
                                                            ...
                                                            @forelse ($employees->where('currency_id',$payroll_rate->currency_id) as $key => $req_employee)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        ...
                                                                        <input type="hidden" name="employeerNssf"
                                                                            value="{{ $employerNssf }}">
                                                                    </td>
                                                                    <td class="text-end">
                                                                        @php
                                                                        ...
                                                                        <input type="hidden" name="employeeNssf"
                                                                            value="{{ $employeNssf }}">
                                                                    </td>
                                                                    <td class="text-end">
                                                                        @php
                                                                        ...
                                                                        <input type="hidden" name="totalNssf"
                                                                            value="{{ $totalNssf }}">
                                                                    </td>
                                                                    <td class="text-end">
                                                                        @php
                                                                        ...
                                                                        <input type="hidden" name="netIncome"
                                                                            value="{{ $netSalary }}">
                                                                    </td>
                                                                    <td class="text-end">
                                                                        <a href="javascript:void(0)"
                                                                            wire:click="addEmployee({{ $payroll_rate->id }}, {{ $req_employee->id }})"
                                                    ...
                                                    <button wire:click="addAllEmployees({{ $payroll_rate->id }})"
                                                        class="btn btn-primary btn-xs float-end m-2">Add All
                                                        {{ $cur }} Employee salaries to payroll</button>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="card-header">
                                                        <div class="row align-items-center">
                                                            <div class="col">                      
                                                                <h6 class="text-success text-center">Generated Empoyee Payroll list for
                                                                    {{ $payroll_rate->currency?->code }} @ {{ $payroll_rate->rate }} rate
                                                                </h6>
                                                            </div><!--end col-->
                                                            <div class="col-auto"> 
                                                                <div class="dropdown">
                                                ...
                                                <table
                                                    ...
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th>Gross + NSSF 10%({{ $payroll_rate->currency?->code }})
                                                            </th>
                                                            <th>Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($payroll_employees->where('currency_id', $payroll_rate->currency_id) as $key => $emp_payroll)
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    @php
                                                                        $employerNssf = $emp_payroll->emp_nssf;
                                                                    @endphp
                                                                    @moneyFormat($employerNssf)
                                                                </td>
                                                                <td class="text-end">
                                                                    @php
                                                                        $employeNssf = $emp_payroll->worker_nssf;
                                                                    @endphp
                                                                    @moneyFormat($employeNssf)
                                                                </td>
                                                                <td class="text-end">
                                                                ...
                                                                <td class="text-end">
                                                                    @php
                                                                        $totalDeduction = $employeNssf + $emp_payroll->paye;
                                                                ...
                                                                <td class="text-end">
                                                                    @php
                                                                        $employerNssfForegine = $employerNssf / $payroll_rate->rate;
                                                                        $grossSalaryForeign = $emp_payroll->salary + $employerNssfForegine;
                                                                    @endphp
                                                                    @moneyFormat($grossSalaryForeign)
                                                                </td>
                                                                <td class="table-action">
                                                                    <a href="{{ route('finance-gen_pay_slip', $emp_payroll->id) }}"
                                                                        target="_blank" class="text-primary"
                                                                        title="view {{ $emp_payroll->employee->fullName }} payslip">
                                                                        <i class="fa fa-download"></i>
                                                                    </a>
                                                                    <a href="{{ route('finance-gen_pay_slip', $emp_payroll->id) }}"
                                                                        target="_blank" class="text-info"
                                                                        title="view {{ $emp_payroll->employee->fullName }} detailed">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a>
                                                                    @if ($emp_payroll->status == 'Pending')
                                                                        <a href="javascript:void()"
                                                                            title="remove {{ $emp_payroll->employee->fullName }} from payroll"
                                                                            class="text-danger"
                                                                        ...
                                                                        <a href="javascript:void()"
                                                                            ...
                                                                            data-bs-target="#markPaid"
                                                                            wire:click="markAsPaid({{ $emp_payroll->id }}, 'Single')"
                                                                            class="text-success"
                                                                            title="mark {{ $emp_payroll->employee->fullName }} as paid">
                                        ...
                                        <a href="javascript:void()" data-bs-toggle="modal" data-bs-target="#markPaid"
                                            wire:click="markAsPaid({{ $payroll_rate->id }}, 'PayrollRate')"
                                            class="text-success m-2 btn-xs btn btn-outline-success float-end"
                                            title="mark {{ $payroll_rate->currency->code }} as paid">
                                            <i class="fa fa-check"></i>Mark All {{ $payroll_rate->currency->code }}
                                            salaries as paid
                                        </a>
                                    </div> <!-- end card body-->
                                @endforeach
    ...
    @include('livewire.finance.payroll.inc.new-currency-rate')
    @push('scripts')
        <script>
