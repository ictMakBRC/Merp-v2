<div>
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Department/Project Accounts (<span class="text-danger fw-bold">{{ $accounts->total() }}</span>)
                                        @include('livewire.layouts.partials.inc.filter-toggle')
                                    @else
                                        Edit Department/Project Accounts 
                                    @endif
    ...
    @include('livewire.finance.ledger.inc.ledger-account-form')
   {{-- Add/update modal --}}
