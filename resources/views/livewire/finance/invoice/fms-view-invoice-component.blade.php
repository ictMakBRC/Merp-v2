                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                                        
                                            ...
                                            <td class="border-0 font-14 text-dark"><b></b>{{$currency}}@moneyFormat($invoice_data->total_amount)</td>
                                        </tr><!--end tr-->
                                        <tr>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="float-end d-print-none mt-2 mt-md-0">
                                ...
                                <a href="javascript:voide(0)" wire:click="submitInvoice({{$invoice_data->id}})" class="btn btn-de-primary btn-sm">Approve</a>
