                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-3">
                            <label for="ledger_account" class="form-label required">From Account</label>
                            <select id="ledger_account" class="form-control" name="ledger_account" required
                                wire:model="ledger_account">
