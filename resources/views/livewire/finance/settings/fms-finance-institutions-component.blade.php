<div>
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Finacial institutions(<span class="text-danger fw-bold">{{ $institutions->total() }}</span>)
                                    ...
                                    @foreach ($institutions as $key => $institution)
                                        <tr @if ($institution->is_budget_institution == 1) class="text-success" @endif>
                                            ...
                                            <td class="table-action">
                                                <button wire:click="editData({{ $institution->id }})" data-bs-toggle="modal" data-bs-target="#updateCreateModal" class="action-ico btn-sm btn btn-outline-success mx-1">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="btn-group float-end">
                                    {{ $institutions->links('vendor.livewire.bootstrap') }}
                                </div>
                            </div>
                        </div>
                    </div> <!-- end tab-content-->
    ...
    @include('livewire.finance.settings.inc.new-financial-institution-form')
    @push('scripts')
            <script>
