<div>
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Chart of Account Types (<span class="text-danger fw-bold">{{ $accountTypes->total() }}</span>)
                                    ...
                                    @foreach ($accountTypes as $key => $accountType)
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <button disabled wire:click="editData({{ $accountType->id }})" data-bs-toggle="modal" data-bs-target="#updateCreateModal" class="action-ico btn-sm btn btn-outline-success mx-1">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="btn-group float-end">
                                    {{ $accountTypes->links('vendor.livewire.bootstrap') }}
                                </div>
                            </div>
                        </div>
                    </div> <!-- end tab-content-->
    ...
    {{-- @include('livewire.human-resource.settings.inc.new-accountType-form') --}}
    @push('scripts')
            <script>
