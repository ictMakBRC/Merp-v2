<div wire:ignore.self class="modal fade" id="updateCreateModal" tabindex="-1" role="dialog" aria-labelledby="updateCreateModalTitle" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form  @if ($toggleForm) wire:submit.prevent="updateInvCategory" @else wire:submit.prevent="storeInvCategory" @endif >
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            <label for="account_id" class="form-label required">{{ __('Account') }}</label>
                            <select class="form-select select2" id="account_id" wire:model.defer="account_id">
