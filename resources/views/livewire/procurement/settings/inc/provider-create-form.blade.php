<div>
    <form wire:submit.prevent="storeProvider">
        <div class="row">
            ...
            {{-- <div class="mb-3 col-md-2">
                <label for="delivery_performance" class="form-label">{{ __('Delivery Performance') }}</label>
                <input type="number" id="delivery_performance" class="form-control"
                    wire:model.defer="delivery_performance" max="5" step="0.1">
                @error('delivery_performance')
                    <div class="text-danger text-small">{{ $message }}</div>
                @enderror
            </div>

            <div class="mb-3 col-md-2">
                <label for="quality_ratings" class="form-label">{{ __('Quality Ratings') }}</label>
                <input type="number" id="quality_ratings" class="form-control" wire:model.defer="quality_ratings"
                    max="5" step="0.1">
                @error('quality_ratings')
                    <div class="text-danger text-small">{{ $message }}</div>
                @enderror
            </div> --}}
