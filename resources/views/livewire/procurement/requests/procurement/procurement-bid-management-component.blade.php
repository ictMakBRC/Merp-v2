                ...
                <div>
                    <div class="card-bod p-0">
                        ...
                        <ul class="nav nav-tabs d-print-none" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" :class="{ 'active': active_tab === 'bid-mgt' }" data-bs-toggle="tab" href="#bid-mgt" role="tab"
                                    aria-selected="false" @click="active_tab = 'bid-mgt'">Bid Management</a>
                            </li>
