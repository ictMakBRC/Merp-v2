...
use App\Data\Finance\Settings\FmsCustomerData;

class CustomerService
{

    public function createUser(FmsCustomerData $userData): FmsCustomer
    {
        $user = new FmsCustomer([
            'name' => $userData->name,
    ...
    public function updateUser(FmsCustomer $user, FmsCustomerData $userData): FmsCustomer
    {
