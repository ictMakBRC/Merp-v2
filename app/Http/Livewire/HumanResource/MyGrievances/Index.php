...
class Index extends Component
{
    ...
    public function filterMyGrievances()
    {
        $user = auth()->user();
    ...
    {
        $data['grievances'] = $this->filterMyGrievances()
            ->orderBy($this->orderBy, $this->orderAsc ? 'asc' : 'desc')
            ->paginate($this->perPage);
        // dd($data);
        return view('livewire.human-resource.my-grievances.index', $data)->layout('layouts.app');
    }
}
