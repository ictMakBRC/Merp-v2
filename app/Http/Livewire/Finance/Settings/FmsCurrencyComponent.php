...
class FmsCurrencyComponent extends Component
{
    ...
    public function editData(FmsCurrency $currency)
    {
    ...
    {
        $currencies = FmsCurrency::search($this->search)
    ...
    public function render()
    {
        ...
        return view('livewire.finance.settings.fms-currency-component',$data);
    }
}
